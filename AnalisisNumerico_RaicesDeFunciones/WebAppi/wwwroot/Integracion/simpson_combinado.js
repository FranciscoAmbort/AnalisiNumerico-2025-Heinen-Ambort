...
// ✅ 4. Función 'calcular' actualizada para Simpson Combinado
async function calcular() {
    ...
    try {
        // La URL del endpoint es '/api/integracion/simpson-combinado'
        const response = await fetch('/api/integracion/simpson-combinado', {
            method: 'POST',
